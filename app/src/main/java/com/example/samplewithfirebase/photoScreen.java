    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takePhoto.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                intent.putExtra("total_rec_hrs",total_rec_hrs.getText().toString());
                intent.putExtra("total_rec_min",total_rec_min.getText().toString());
                intent.putExtra("total_rec_sec",total_rec_sec.getText().toString());
                intent.putExtra("int_hr",int_hr.getText().toString());
                intent.putExtra("int_min",int_min.getText().toString());
                intent.putExtra("int_sec",int_sec.getText().toString());
